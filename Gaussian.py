...
def Gaussian_geq(num_noisy,s1,s2):
...
def Gaussian_leq(x2,sigma1, sigma2):
...
s1=(2*np.log(1.25/delta))**0.5/e1
s2=(2*np.log(1.25/delta))**0.5/e2
...
for i in range(test_time):
    ...
    list_12=[Gaussian_geq(i,s1,s2) for i in list_1]
    list_21=[Gaussian_leq(i,s1,s2) for i in list_2]

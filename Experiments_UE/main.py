...
#0,2,6,8;workclass,marital-status,sex,income

column = 2

true_list=[int(i) for i in list(dict(data[column].value_counts()).values())]
...
for epsilon_list in epsilon_tuple:
    test.UE_test(true_list,num1,epsilon_list,test_time=100)
...
epsilon=0.1
data=test.k_test(true_list,epsilon,7,test_time=100)
